...
#define STRING_CONFIG_H_AUTHOR "(JM, Delta config/RRDGLCD)" // Who made the changes.
...
#define DELTA_SMOOTH_ROD_OFFSET (267.5441 + 3.3) // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 45.85 // mm
...
#define Z_MIN_POS -20 // allow for z height tuning
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {55.01, 55.01, 55.01, 710.0}  // default steps per unit for Kossel (GT2, 20 tooth)
