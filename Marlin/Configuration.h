...
#define STRING_CONFIG_H_AUTHOR "(Jim, default config)" //Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {55.02,55.02,55.02,760*1.1}  // default steps per unit for ultimaker 
