...
// EPCOS B57540G0104F000 Digikey 495-2125-ND
// ./createTemperatureLookupMarlin.py --rp=4700 --t1=25.0:100000.0 --t2=150.0:1655.0 --t3=250.0:227.8 --num-temps=36
// Steinhart-Hart Coefficients: 0.000722994385489504, 0.00021619776956638,  9.30225494536848e-08 
//#define NUMTEMPS 36
const short temptable_70[][2] PROGMEM = {
	{(short)(12.35*OVERSAMPLENR), 350}, // v=0.0603177370646 r=57.3910120355 res=6.68836481695 C/count
	{(short)(13.89*OVERSAMPLENR), 340}, // v=0.0678015169686 r=64.609551065 res=5.80805167395 C/count
	{(short)(15.66*OVERSAMPLENR), 330}, // v=0.0764831824323 r=73.0110144337 res=5.02252530389 C/count
	{(short)(17.73*OVERSAMPLENR), 320}, // v=0.0865927183308 r=82.8316792856 res=4.32475797799 C/count
	{(short)(20.15*OVERSAMPLENR), 310}, // v=0.0984107385613 r=94.3633679951 res=3.70784237963 C/count
	{(short)(23.00*OVERSAMPLENR), 300}, // v=0.112280766049 r=107.968476742 res=3.16503957991 C/count
	{(short)(26.34*OVERSAMPLENR), 290}, // v=0.128624635837 r=124.099611145 res=2.68982242183 C/count
	{(short)(30.30*OVERSAMPLENR), 280}, // v=0.147961780846 r=143.325410594 res=2.27591382874 C/count
	{(short)(35.01*OVERSAMPLENR), 270}, // v=0.170933288279 r=166.364745585 res=1.91731970158 C/count
	{(short)(40.62*OVERSAMPLENR), 260}, // v=0.19833171138 r=194.13232807 res=1.60835621879 C/count
	{(short)(47.34*OVERSAMPLENR), 250}, // v=0.231137627339 r=227.8 res=1.34367149671 C/count
	{(short)(55.41*OVERSAMPLENR), 240}, // v=0.270563737829 r=268.879734772 res=1.11826170526 C/count
	{(short)(65.15*OVERSAMPLENR), 230}, // v=0.318106721345 r=319.336965056 res=0.927481861118 C/count
	{(short)(76.92*OVERSAMPLENR), 220}, // v=0.375605742761 r=381.746644593 res=0.767051637122 C/count
	{(short)(91.20*OVERSAMPLENR), 210}, // v=0.445303992942 r=459.510088837 res=0.633056636359 C/count
	{(short)(108.52*OVERSAMPLENR), 200}, // v=0.52990511738 r=557.159102231 res=0.521945683128 C/count
	{(short)(129.56*OVERSAMPLENR), 190}, // v=0.632608924251 r=680.786742568 res=0.430524790172 C/count
	{(short)(155.05*OVERSAMPLENR), 180}, // v=0.757099380088 r=838.663783383 res=0.355948581813 C/count
	{(short)(185.84*OVERSAMPLENR), 170}, // v=0.907442401558 r=1042.13054666 res=0.295710103971 C/count
	{(short)(222.79*OVERSAMPLENR), 160}, // v=1.0878335721 r=1306.90191307 res=0.247630161798 C/count
	{(short)(266.68*OVERSAMPLENR), 150}, // v=1.30212431157 r=1655.0 res=0.209847637436 C/count
	{(short)(318.07*OVERSAMPLENR), 140}, // v=1.55306591116 r=2117.65284578 res=0.180812725081 C/count
	{(short)(377.09*OVERSAMPLENR), 130}, // v=1.84127063555 r=2739.70036321 res=0.159285795537 C/count
	{(short)(443.19*OVERSAMPLENR), 120}, // v=2.16402315059 r=3586.38640151 res=0.144345866361 C/count
	{(short)(514.92*OVERSAMPLENR), 110}, // v=2.51427608994 r=4753.98638398 res=0.135414749299 C/count
	{(short)(589.89*OVERSAMPLENR), 100}, // v=2.88034330104 r=6386.70097925 res=0.132306478046 C/count
	{(short)(664.94*OVERSAMPLENR), 90}, // v=3.2467871725 r=8703.96307362 res=0.135317674575 C/count
	{(short)(736.59*OVERSAMPLENR), 80}, // v=3.5966267635 r=12045.3670832 res=0.145385098576 C/count
	{(short)(801.66*OVERSAMPLENR), 70}, // v=3.91434908499 r=16946.0002705 res=0.164355543984 C/count
	{(short)(857.84*OVERSAMPLENR), 60}, // v=4.18868462057 r=24265.3081846 res=0.195447925213 C/count
	{(short)(904.02*OVERSAMPLENR), 50}, // v=4.41414484215 r=35412.3036727 res=0.244052870919 C/count
	{(short)(940.22*OVERSAMPLENR), 40}, // v=4.59093610321 r=52748.2377561 res=0.319143234702 C/count
	{(short)(967.40*OVERSAMPLENR), 30}, // v=4.72360863014 r=80324.3624158 res=0.435830777837 C/count
	{(short)(986.97*OVERSAMPLENR), 20}, // v=4.81918828343 r=125269.453562 res=0.620170507489 C/count
	{(short)(1000.54*OVERSAMPLENR), 10}, // v=4.88546286089 r=200473.624751 res=0.918633293117 C/count
	{(short)(1009.62*OVERSAMPLENR), 0}  // v=4.92977497909 r=329938.561805 res=1.41807002488 C/count
};
#endif
